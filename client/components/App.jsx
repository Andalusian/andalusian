...
class App extends React.Component {
  ...
  listFunctions() {
    ...
    axios
      ...
      .then(data => {
        ...
        this.setState({ awsCurrentFunctions: allFuncArray });
        this.setState({ awsShortCurrentFunctions: shortAllFuncArray });
      })
  ...
  render() {
    ...
    if ((this.state.pageSelect === '' && this.state.isLogin && !this.state.loading)) {
    ...
    else if ((this.state.pageSelect === 'Gcloud' && this.state.isLogin)) {
      ...
      displayed = (<React.Fragment>
        <AWSFunctionForm id="AWSFunctionForm"
          awsCurrentFunctions={this.state.awsCurrentFunctions}
